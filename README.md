...
### 3. Set Up the Study Extension

**For Qwen:**
```bash
qwen extensions install https://github.com/planetis-m/study.git
```

**For Gemini:**
```bash
gemini extensions install https://github.com/planetis-m/study.git
```
...
Then run `/help` to confirm that the `study` commands are available.
...
# Transcribe text from a single PDF
/study:transcribe lecture1.pdf

# Transcribe specific page ranges
/study:transcribe lecture1.pdf --pages "8-20,22-27" > lecture1.md

# Combine multiple sources into one study file (use >> to append)
/study:transcribe lecture2_part1.pdf --pages "1-20" > study_guide.md
/study:transcribe lecture2_part2.pdf --pages "5-10" >> study_guide.md

# Analyze already-transcribed text content
/study:analyze "Paste your transcribed slide content here..."

# Generate essay questions
/study:essay "Paste content here..."

# Complete pipeline (transcribe -> analyze)
/study:study-notes lecture1.pdf

# Generate practice quizzes
/study:quiz "Paste your slide content here..."

# Analyze transcribed text
/study:analyze lecture1.md
```
...
└── commands/
    └── study/
        ├── transcribe.toml   # Basic preprocessing command using pdfocr
...
1. **Separation of Concerns**: Commands are separated into discrete stages (transcribe, analyze) while also providing a convenient combined command (study-notes).
2. **Flexible Input**: Users can either pass PDF files directly or paste pre-transcribed text for analysis.
